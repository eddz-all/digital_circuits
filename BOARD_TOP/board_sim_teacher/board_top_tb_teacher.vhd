...
entity board_top_tb_teacher is
end entity board_top_tb_teacher;

architecture sim of board_top_tb_teacher is
...
begin
    ...
    begin
        ...
        wait_cycles(clk_in1, 3000);
        report "board_top_tb_teacher completed" severity note;
        stop;
    end process;
