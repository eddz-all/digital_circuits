## Board constraints for the multicore4 non-pipelined board_top.
## Top-level ports:
...
## Reset input.
## This uses the same physical pin as the existing BOARD_TOP project.
## In this RTL, rst_btn = 1 means reset asserted.
set_property PACKAGE_PIN AC3 [get_ports rst_btn]
set_property IOSTANDARD LVCMOS18 [get_ports rst_btn]

## Debug hub clock for ILA.
## If Vivado warns that dbg_hub does not exist before debug insertion, apply
## these after the ILA debug core is generated.
